...
$SQL="select prodId, prodName, prodPicName from product"; //Create a new variable containing the execution of the SQL query i.e. select the records or get out 

$exeSQL=mysqli_query($con,$SQL) or die (mysqli_error());

//create an array of records (2 dimensional variable) called $prodArray. //populate it with the records retrieved by the SQL query previously executed. //loop through the array i.e while the end of the array has not been reached go through it 

while ($arrayprod=mysqli_fetch_array($exeSQL)) { 

    echo "<br>"; echo "<img src=images/".$arrayprod['prodPicName'].".jpg>";
    ...
    //display the product
    echo "<br>"; echo $arrayprod['prodName']; echo "</a><br><br>"; echo "<hr>";
