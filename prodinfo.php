...
//displaying the image of the curretn product
echo "<br>"; echo "<img src=images/".$thearrayprod['prodPicName'].".jpg>";

echo"<br>"; echo "<p>".$thearrayprod['prodDescrip']."</p";

echo "<br>"; echo "<p> £".$thearrayprod['prodPrice']."</p>";

echo "<br>"; echo "<p> Number in Stock :".$thearrayprod['prodQuantity']."</p>";
...
//drop down to get the quantity number of products remaing and select the number of products needed
echo "<select name=p_quan >";
